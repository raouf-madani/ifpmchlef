...
if($post->comment_status == 'open'){
  ...
  ?>
    <h3 class="heading"><span><?php _e('Revues de cours','vibe'); ?></span></h3>
      ...
      <div class="col-md-6">
        <div class="rating_snapshot">
          ...
          echo '<div class="modern-star-rating">';
              ...
              echo '</div>';
              echo '<span>'.$count.' '.__('évalatuion','vibe').'</span>';
          ?>
        </div>
      </div>
      <div class="col-md-6">
        ...
        <?php
          ...
          foreach($ratings as $k => $rating){
            ...
            echo '<li><span>'.$k.' '.__('étoiles','vibe').'</span><strong><span style="width:'.(100*($rating/$count)).'%">'.$rating.'</span></strong></li>';
          }
        ?>
        </ul>
      </div>
    ...
    <div class="show_course_reviews">
        ...
        if (get_comments_number()==0) {
          echo '<div id="message" class="notice"><p>';_e('Aucun avis trouvé pour ce cours.','vibe');echo '</p></div>';
        }else{
        ?>
