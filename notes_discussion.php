        ...
        <div class="row">
            <div class="col-md-9 col-sm-8">
            	<form action="" method="post" id="notes-discussion-form">
					<div class="note-tabs">
						<ul>
							<li id="wplms_all"class="selected"><a href=""><?php _e('Toutes les notes et discussions','vibe'); ?></a></li>
							<?php $selected = 1;
							...
							if(current_user_can('edit_posts')){
								?>
								<li id="wplms_instructor_unit_notes"><a href=""><?php _e("Notes sur l'unité",'vibe'); ?></a></li>
								<li id="wplms_instructor_unit_discussions"><a href=""><?php _e("Discussions sur l'unité",'vibe'); ?></a></li>
								<?php
								$selected =0;
							}
							?>
							<li id="wplms_my_notes_public"><a href=""><?php _e('Mes Discussions','vibe'); ?></a></li>
							<li id="wplms_my_notes_private"><a href=""><?php _e('Mes Notes','vibe'); ?></a></li>
						</ul>
					</div><!-- .item-list-tabs -->
				</form>
                ...
                <div class="content">
                    ...
                    <?php
                    if(is_user_logged_in() || (!is_user_logged_in() && $args['comment__in'] && count($args['comment__in']) )){
                    	...
                    	?>
                    	<div class="message"><?php _e('Aucun commentaire public trouvé !','vibe') ?></div>
                    	<?php
                    }
