        ...
        <div class="row">
            <div class="col-md-12">
                <div class="pagetitle">
                    ...
                    <h1><?php _e('Résultats de recherche pour "', 'vibe'); the_search_query(); ?>"</h1>
                ...
                <?php
                    ...
                    if($categories){
                        foreach($categories as $category) {
                            $cats .= '<li><a href="'.get_category_link( $category->term_id ).'" title="' . esc_attr( sprintf( __( "Voir tous les articles sur %s","vibe" ), $category->cat_name ) ) . '">'.$category->cat_name.'</a></li>';
                        }
                    }
                    $cats .='</ul>';
                    ...
                    endwhile;
                        ...
                        echo '<h3>'.__('Désolé, aucun résultat trouvé.','vibe').'</h3>';
                    endif;
                    pagination();
                ?>
            </div>
